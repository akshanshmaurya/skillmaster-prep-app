...
export default function Home() {
  const stats = [
    { label: "Tests Taken", value: "24", icon: Target, color: "text-blue-500" },
    { label: "Questions Solved", value: "342", icon: CheckCircle2, color: "text-green-500" },
    { label: "Study Hours", value: "48", icon: Clock, color: "text-purple-500" },
    { label: "Rank", value: "#127", icon: TrendingUp, color: "text-orange-500" },
  ];
